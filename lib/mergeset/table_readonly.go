...
var rawItemsShardsPerTableReadOnly = func() int {
...
func (riss *rawItemsShards) init() {
	riss.shards = make([]rawItemsShard, rawItemsShardsPerTableReadOnly)
}

func (riss *rawItemsShards) addItems(tb *TableReadOnly, items [][]byte) {
	shards := riss.shards
...
func (riss *rawItemsShards) addIbsToFlush(tb *TableReadOnly, ibsToFlush []*inmemoryBlock) {
	if len(ibsToFlush) == 0 {
		return
	}
...
func (tb *TableReadOnly) startBackgroundWorkers() {
...
func (tb *TableReadOnly) startInmemoryPartsMergers() {
	tb.partsLock.Lock()
...
func (tb *TableReadOnly) startInmemoryPartsMergerLocked() {
	select {
	case <-tb.stopCh:
		return
	default:
...
func (tb *TableReadOnly) startFilePartsMergers() {
	tb.partsLock.Lock()
...
func (tb *TableReadOnly) startFilePartsMergerLocked() {
	select {
	case <-tb.stopCh:
		return
	default:
...
func (tb *TableReadOnly) startPendingItemsFlusher() {
	tb.wg.Add(1)
	go func() {
...
func (tb *TableReadOnly) startInmemoryPartsFlusher() {
	tb.wg.Add(1)
	go func() {
...
func (tb *TableReadOnly) startFlushCallbackWorker() {
...
func (tb *TableReadOnly) MustClose() {
...
// TableReadOnlyMetrics contains essential metrics for the TableReadOnly.
type TableReadOnlyMetrics struct {
...
func (tm *TableReadOnlyMetrics) TotalItemsCount() uint64 {
	return tm.InmemoryItemsCount + tm.FileItemsCount
}

// UpdateMetrics updates m with metrics from tb.
func (tb *TableReadOnly) UpdateMetrics(m *TableReadOnlyMetrics) {
...
func (tb *TableReadOnly) AddItems(items [][]byte) {
...
func (tb *TableReadOnly) mergeInmemoryPartsToFiles(pws []*partWrapper) error {
	pwsLen := len(pws)
...
func (tb *TableReadOnly) DebugFlush() {
...
func (tb *TableReadOnly) pendingItemsFlusher() {
...
func (tb *TableReadOnly) inmemoryPartsFlusher() {
	// do not add jitter in order to guarantee flush interval
...
func (tb *TableReadOnly) flushPendingItems(isFinal bool) {
	tb.flushPendingItemsWG.Add(1)
	tb.rawItems.flush(tb, isFinal)
	tb.flushPendingItemsWG.Done()
}

func (tb *TableReadOnly) flushInmemoryItemsToFiles() {
	tb.flushPendingItems(true)
	tb.flushInmemoryPartsToFiles(true)
}

func (tb *TableReadOnly) flushInmemoryPartsToFiles(isFinal bool) {
...
func (riss *rawItemsShards) flush(tb *TableReadOnly, isFinal bool) {
...
func (tb *TableReadOnly) flushBlocksToInmemoryParts(ibs []*inmemoryBlock, isFinal bool) {
	if len(ibs) == 0 {
		return
	}
...
func (tb *TableReadOnly) addToInmemoryParts(pw *partWrapper, isFinal bool) {
...
func (tb *TableReadOnly) mustMergeInmemoryParts(pws []*partWrapper) []*partWrapper {
...
func (tb *TableReadOnly) mustMergeInmemoryPartsFinal(pws []*partWrapper) *partWrapper {
	if len(pws) == 0 {
...
func (tb *TableReadOnly) createInmemoryPart(ibs []*inmemoryBlock) *partWrapper {
...
func (tb *TableReadOnly) mustMergeIntoInmemoryPart(bsrs []*blockStreamReader, flushToDiskDeadline time.Time) *partWrapper {
...
func (tb *TableReadOnly) NotifyReadWriteMode() {
	tb.startInmemoryPartsMergers()
	tb.startFilePartsMergers()
}

func (tb *TableReadOnly) inmemoryPartsMerger() {
	for {
...
func (tb *TableReadOnly) filePartsMerger() {
	for {
		if tb.isReadOnly.Load() {
			return
		}
...
func (tb *TableReadOnly) mergeParts(pws []*partWrapper, stopCh <-chan struct{}, isFinal bool) error {
	if len(pws) == 0 {
...
func (tb *TableReadOnly) mergePartsInternal(dstPartPath string, bsw *blockStreamWriter, bsrs []*blockStreamReader, dstPartType partType, stopCh <-chan struct{}) (*partHeader, error) {
	var ph partHeader
...
func (tb *TableReadOnly) swapSrcWithDstParts(pws []*partWrapper, pwNew *partWrapper, dstPartType partType) {
...
func (tb *TableReadOnly) nextMergeIdx() uint64 {
...
func (tb *TableReadOnly) CreateSnapshotAt(dstDir string) error {
	logger.Infof("creating TableReadOnly snapshot of %q...", tb.path)
	startTime := time.Now()
	...
	logger.Infof("created TableReadOnly snapshot of %q at %q in %.3f seconds", srcDir, dstDir, time.Since(startTime).Seconds())
	return nil
}
