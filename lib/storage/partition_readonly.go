...
func mustOpenPartitionReadOnly(smallPartsPath, bigPartsPath string, s *ReadOnlyStorage) (*partition, error) {
	...
	pt := newPartition(name, smallPartsPath, bigPartsPath, nil) // Storage is used for merging so hopefully, we can get away with nil
